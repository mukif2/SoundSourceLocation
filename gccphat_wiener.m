function [azimuth, elevation] = gccphat_wiener(audio,noise)
    ...
    wienerMode                 = 'Attenuation';         % Wiener filtering mode {'[]' 'Attenuation' 'Emphasis'}
    wienerRefSignal            = noise;         % Excerpt of the source(s) to be emphasized or attenuated
    % Display results
...
%         wav_frame = 
    ...
    [azimuth, elevation, ~, ~] = MBSS_locate_spec(audio,wienerRefSignal,sMBSSParam);
